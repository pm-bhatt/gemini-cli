...
describe('ToolResultDisplay', () => {
  ...
  it('renders string result as markdown by default', () => {
    ...
    expect(output).toContain('MarkdownDisplay: Some result');
  });
  ...
  it('renders string result as plain text when renderOutputAsMarkdown is false', () => {
    ...
    expect(output).toContain('Some result');
    expect(output).not.toContain('MarkdownDisplay');
  });

  it('truncates very long string results', { timeout: 10000 }, () => {
    ...
    expect(output).toContain('aaaaa'); // Check for some content
  });
  ...
  it('renders file diff result', () => {
    ...
    expect(output).toContain('DiffRenderer: test.ts - diff content');
  });
  ...
  it('renders ANSI output result', () => {
    ...
    expect(output).toContain('AnsiOutputText: {"text":"ansi content"}');
  });
