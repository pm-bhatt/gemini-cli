...
describe('Notifications', () => {
  ...
  it('renders init error', () => {
    ...
    const { lastFrame } = render(<Notifications />);
    const output = lastFrame();
    expect(output).toContain('Initialization Error: Something went wrong');
    expect(output).toContain('Please check API key');
  });
  ...
  it('renders screen reader nudge when enabled and not seen', async () => {
    ...
    const output = lastFrame();
    expect(output).toContain('screen reader-friendly view');
  });
